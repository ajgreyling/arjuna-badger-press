...
> [← Craft Glossary](../CRAFT_GLOSSARY.md) · *The Machinery (this repo's quality tools)*
...
**See:** `.claude/skills/de-llm-loop/SKILL.md` · `academic/EXTERNAL_EDITORIAL_FEEDBACK.md`
