...
> [← Craft Glossary](../CRAFT_GLOSSARY.md) · *Structure & Story*
...
beat order.
**See:** `craft/CRAFT_DOCTRINE.md` (L-02: "plant the climax rhyme early and quietly") · `storygraph/DESIGN.md` ("plant must precede payoff")
