...
## How the house pays for itself (2026-06-20 pivot)
...
|---|---|---|
| **Primary (1 good novel)** | ✅ | Exceeded — multiple volumes, craft-guarded |
...
| **Platform login UI / study-Bible reader** | 🟡 | Public reader + R2 downloads live · full workshop UI still ahead |
...
| **Revenue model (Arjuna Audio)** | 🟡 | **Pivot locked:** paid human-narrated audiobooks · local voice talent · [narrator intake live](https://arjunabadger.press/narrators.html) |
