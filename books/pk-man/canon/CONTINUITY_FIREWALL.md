...
```mermaid
flowchart TD
    A["2031 · Book I<br/>The unlogged sting (L-14)"] --> B["2033-34 · Book II<br/>Convergence · partition<br/>join keys destroyed (L-18)"]
    B --> C["2035 · Afrika 2035<br/>corpus intact · graph gone (L-27)"]
    C --> D["2036-37 · INTERFACE ONE<br/>a regional instance reads<br/>what the global one could not"]
    A -.->|"never closed"| D
```
