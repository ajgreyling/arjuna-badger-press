...
|---|---|---|---|
| 1 | **H** | **Season jump at the open:** Paarl dig = "late-summer" (ch-2) vs Cape Town = "July/winter" (ch-2/3), apparently days apart. | **Partially fixed (2026-06-14):** ch-2 now inserts an explicit four-month gap (Paarl dig → panel ruin → Observatory flat, late July); ch-3 opening retargeted to Observatory/Lower Main. Re-run `natural_world_check.py` after any open-chapter edit. |
