...
**Track B: Bk II ch-01–11 drafted (~22.5k) — Acts One + Two + the fracture opened** (G6/G7 soft
canon; the thrones divided; the tie resolved; Ronel gone); independent canon cold-read applied to every pass; SynergyEngine standings live through ch-04).
...
## State at pause (~49.1k / ~220k words, ~22%)
...
- **Book II:** **ch-01–06 ✅ drafted (~14.3k) — ACT ONE (ASSEMBLY) FIRST-DRAFT COMPLETE**
  (`manuscript/book-ii/`; G6/G7 soft canon awaiting AJ). Next: ch-12 "Ronel gone" (her POV debut).
  SynergyEngine CURRENT STANDINGS live through ch-11 — update after every ensemble scene.
