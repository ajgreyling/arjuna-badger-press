#!/usr/bin/env python3
"""Lay title + author typography onto the clean cover plate for *The Way That Was Invented*.

    python3 books/the-unheard/books/japan-ainu/design/make_cover.py
"""
...
def main() -> None:
    ...
    for y in range(top_end):
        ...
        sd.line([(0, y), (W, y)], fill=(8, 6, 10, a))
    bot_start = int(H * 0.80)
    for y in range(bot_start, H):
        a = int(195 * ((y - bot_start) / (H - bot_start)) ** 1.15)
