#!/usr/bin/env python3
"""Assemble and render ONE RECORD, Book I: The Record.
...
OUT = ROOT / "build" / "export" / "The Record"
...
def assemble() -> None:
    ...
    # makes Pandoc emit a plain \maketitle page before the full-bleed PDF cover.
    frontmatter = """---
lang: en-ZA
