...
Book I did not work, and the reason was structural rather than fixable by better beats.

- **No clock.** Nothing forced anything to happen by any date. The pressure was institutional —
  custody, admissibility, provenance, queue priority — and institutional pressure has no deadline.
- **No body.** Nothing was ever physically at risk. Every threat was a letter, an injunction or a
  reputational freeze.
- **No protagonist.** Five co-equal POVs across five cities means nobody carries the book, and the
  reader has nobody to solve alongside.
...
Competence under a deadline. One mind the reader lives inside, working real problems with real
constraints, failing informatively, improvising at cost, cracking jokes because the alternative is
screaming.

| Weir rule | How it binds here |
|---|---|
| One protagonist | **Dries Venter.** The other four are voices he works problems *with*, not POVs |
| The disaster is on page one | **Cold open** on the receipt that predates its own request |
| Problem → attempt → failure → new information → worse problem | Every sequence. Failure must be **diagnostic**, never merely delay |
| The reader can solve along | The problem is legible before the solution arrives |
| Hard clock, visible | Eleven months, stated, and referenced by remaining-days |
| Physical jeopardy | **Part Four is on the ice.** Cold, power, isolation, a station that is failing |
| Humour under pressure | Technopark bluntness, the forbidden-phrase jar, Ghana–Nairobi rivalry |
| Science is load-bearing and checkable | Landauer is real. The uncertainty field is honest. No hand-waving |

**What Weir mode does NOT license:** softening the ethics, cutting the family, making Africa a
