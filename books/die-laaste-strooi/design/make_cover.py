#!/usr/bin/env python3
"""Cover for *Die Laaste Strooi* — house colophon treatment (no commissioned art).

    python3 books/die-laaste-strooi/design/make_cover.py
"""
...
def main() -> None:
    ...
    y = 1560
    f_title = font("AtkinsonHyperlegible-Bold.otf", 112)
    for line in TITLE.split("\n"):
        y = centre(d, y, line, f_title, IVORY) + 44

    y += 34
    d.line([(W // 2 - 150, y), (W // 2 + 150, y)], fill=GOLD_DIM, width=3)
    y += 58

    y = centre(d, y, SUB, font("AtkinsonHyperlegible-Italic.otf", 46), GOLD) + 10
