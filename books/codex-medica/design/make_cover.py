#!/usr/bin/env python3
"""Lay title + author typography onto the clean cover plate for *Codex Medica*.

    python3 books/codex-medica/design/make_cover.py
"""
...
def main() -> None:
    ...
    # Darken edges so cream type holds over the lit paper stack.
    scrim = Image.new("RGBA", (W, H), (0, 0, 0, 0))
    sd = ImageDraw.Draw(scrim)
    top_end = int(H * 0.32)
    for y in range(top_end):
        a = int(175 * (1 - y / top_end) ** 1.25)
        sd.line([(0, y), (W, y)], fill=(18, 12, 8, a))
