#!/usr/bin/env python3
"""Assemble and render *The Sky Still Runs the House*.

Canonical prose lives in manuscript/. Derived BOOK.md and exports stay under build/.
All EPUB/PDF output passes through the press render gate.
"""
...
OUT = ROOT / "build" / "export" / "The Sky Still Runs the House"

TITLE = "The Sky Still Runs the House"
